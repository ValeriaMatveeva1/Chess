...
/*
    функции инициализации и очистки вектора
*/
...
/*
    функции векетора, с которыми работает пользователь
*/
#define v_push(v, val) (_vector_expand(_vector_args(v)) ? -1 :((v)->data[(v)->len++] = (val)), 0)
...
/*
    всего представлено 4 типа, с которыми может работать данная реализация
*/
